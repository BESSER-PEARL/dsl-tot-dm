...
class Tree():
    def __init__(self, n_levels, n_samples, n_votes):
        self.generator_samples = n_samples
        self.evaluator_votes = n_votes
        self.number_levels = n_levels
        self.levels = []
    ...
    def set_problem(self, problem: ModelingProblem):
