...
def CLERK(args):
    ...
    modelingTasks[0] = Task(level = 1, name = "Extract Atomic Legal Statements from Law Article")
...
Take into account that an atomic statement can have no precondition.""")
    ...
    modelingTasks[1] = Task(level = 2, name = "Classify and Format Atomic Legal Statements")
...
Do not include the Precondition(s) under which the Action(s) should be taken in the Action(s).""")
    ...
    modelingTasks[2] = Task(level = 3, name = "Model Atomic Legal Statements in Legal GRL")
...
4. Connect the «Precondition» created in step 3 to the «Goal» created in step 2  with a Dependency, whereby the «Precondition» is the source.""")
    ...
    modelingTasks[3] = Task(level = 4, name = "Refine Legal GRL model")
