...
3. Run the CLERK program:
   ...
   ```
4. To execute CLERK with a new law article: the law article and focal actors parameters are mandatory, while model focus is optional. The parameters accept text string or a path to a text file. Find more examples [here](input/run_clerk_experiments.sh).
